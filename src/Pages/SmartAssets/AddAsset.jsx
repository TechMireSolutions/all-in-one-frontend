    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 p-6 md:p-12 relative overflow-hidden">
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <header className="mb-12">
          <h1 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tight mb-2">Initialize <span className="text-orange-500">New Asset</span></h1>
          <p className="text-gray-500 font-medium">Enter technical specifications to generate a new hardware entry and QR identity.</p>
        </header>
        ...
        <div className="bg-white border border-gray-200 p-8 md:p-12 rounded-3xl shadow-sm">
          {success ? (
            ...
            >
              ...
              <h2 className="text-3xl font-black text-gray-900 mb-2 uppercase">Asset Registered</h2>
              <p className="text-gray-500">Synchronizing database and generating QR identity...</p>
            </motion.div>
          ) : (
