    ...
    if (window.confirm(`Are you sure you want to delete ${userName}?`)) {
      ...
      try {
        ...
        setTimeout(() => {
          ...
          fetchUsers("employee"); // Refresh the user list
        }, 2000);
      } catch (error) {
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{viewingUser.grade}</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Calendar className="h-5 w-5 text-gray-400" />
                    ...
                    {viewingUser.current_study && (
                      <div className="flex items-center space-x-3">
                        <BookOpen className="h-5 w-5 text-gray-400" />
                        <div>
                          <p className="text-sm text-gray-500">Current Study (Ongoing)</p>
                          <p className="font-medium">{viewingUser.current_study}</p>
                        </div>
                      </div>
                    )}
                    <div className="flex items-center space-x-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      name="current_study"
                      value={editingUser.current_study || ""}
                      onChange={handleInputChange}
                      className="w-full p-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
